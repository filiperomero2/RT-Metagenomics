...
class DatabaseSetupService:
    ...
    def list_kraken2_databases(self) -> list[Kraken2DatabaseConfig]:
        ...
        for saved in stored_databases:
            if saved.value and Path(saved.value).exists() and saved.value not in candidates:
    ...
    def bootstrap_all_databases(
        ...
        paths = self.vu_databases_service.install_all(force=False, on_progress=on_progress)

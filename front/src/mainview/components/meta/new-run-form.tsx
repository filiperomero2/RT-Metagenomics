import { CheckBox } from "@/mainview/components/form/checkbox";
import { Input } from "@/mainview/components/form/input";
import { NumberInput } from "@/mainview/components/form/number-input";
import { Select } from "@/mainview/components/form/select";
import { api } from "@/mainview/lib/axios";
import { MetaGenomic } from "@/mainview/types/meta-genomic";
import {
  Accordion,
  AccordionItem,
  Alert,
...
import { queryKeys } from "@/mainview/utils/query-keys-factory";
import { zodResolver } from "@hookform/resolvers/zod";
import { z } from "zod";

import { Autocomplete } from "@/mainview/components/form/autocomplete";
import {
  META_GENOMIC_FORM_STORAGE_KEY,
  SETTINGS_STORAGE_KEY,
} from "@/mainview/constants/local-storage";
import { useModal } from "@/mainview/hooks/use-modal";
import { SettingsData } from "@/mainview/routes/settings";
